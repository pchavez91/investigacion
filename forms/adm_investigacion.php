...
<div class="panel panel-info">
    ...
    <div class="panel box-shadow-none content-header margin-topbar">
        <div class="form-group col-xs-12 col-lg-12" style="background-color: #39b3d7; border: 1px solid; border-color:#269abc; padding: 10px 3px 10px 5px; line-height: 15px; top:-15px;">
            <!--colocar al estilo-->
            <b><font size=3 color="white"><center>ADMINISTRADOR DE INVENTIGACIONES</center></font></b>
        </div>
    </div>
    ...
    <div class="panel-body">
    	...
    	<div class="col-xs-2 col-lg-2">
			<button type="button" class="btn btn-success" onclick="abrir_ventana_nueva_investigación()"> NUEVA INVESTIGACIÓN</button>
    	</div>
...
<div id="ventana_crea_investigacion" class="modal fade">
    <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
         <center><h4 class="modal-title">CREAR NUEVA INVESTIGACION DE ACCIDENTE</h4></center>
      </div>
      <div class="modal-body"> 
			...
			<div class="row">
			   ...
			   <div class="form-group col-xs-2 col-lg-2">
					...
					<input type="text" class="form-control" name="fecha_nacimiento" id="fecha_nacimiento" required="required" onchange="calcularEdadDesdeInput()" placeholder="Ej: 15-05-1990">
				</div>

				<div class="form-group col-xs-2 col-lg-2">
					<label >EDAD</label>
					<input type="text" class="form-control" name="edad_accidentado" id="edad_accidentado" required="required" readonly>
				</div>
				<div class="form-group col-xs-4 col-lg-4">
				...
				<div "row">
					<div class="form-group col-xs-8 col-lg-8">
						<label>Encargado de la investigacion</leable>
							<select class="form-control" name="seleccionar_usuario" id="seleccionar_usuario" onchange="carga_lista_sucursal()"required="required">
      ...
      <div class="modal-footer">
		<button type="button" class="btn btn-success" onclick="confirma_nuevao_informe()">CONFIRMAR</button>
...
<div id="ventana_agrega_parte_cuerpo" class="modal fade app-modal-header">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
         <center><h4 class="modal-title">AGREGAR NUEVA PARTE DEL CUERPO</h4></center>
      </div>
      <div class="modal-body"> 
      	<div class="row">
	      	<div class="form-group col-xs-12 col-lg-12">
				<label >Escriba nueva parte del cuerpo</label>
				<input type="text" class="form-control" name="nueva_parte_del_cuerpo" id="nueva_parte_del_cuerpo" required="required">
			</div>
      ...
      <div class="modal-footer">
		<button type="button" class="btn btn-success" onclick="confirma_nueva_parte_cuerpo()">CONFIRMAR AGREGAR</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Salir</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
...
<div id="ventana_agrega_un_incidente" class="modal fade app-modal-header">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
         <center><h4 class="modal-title" id="titulo_ventana"></h4></center>
      </div>
      <div class="modal-body">
      <input type="hidden" name="id_danio_ingreso" id="id_danio_ingreso">
      <input type="hidden" name="id_incidente_ingreso" id="id_incidente_ingreso"> 
      <input type="hidden" name="id_causa_inmediata_ingreso" id="id_causa_inmediata_ingreso"> 
      <input type="hidden" name="id_causa_basica_ingreso" id="id_causa_basica_ingreso">  
      <input type="hidden" name="accion_ingreso" id="accion_ingreso"> 


        <label id="descripcion_del_danio"></label><br>
      	<div class="row">
	      	<div class="form-group col-xs-12 col-lg-12">
				<label id="enunciado_input"></label>
				<input type="text" class="form-control" name="nuevo_incidente" id="nuevo_incidente" required="required">
			</div>
      ...
      <div class="modal-footer">
		<button type="button" class="btn btn-success" onclick="agregar_incidente()">CONFIRMAR AGREGAR</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Salir</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
...
<div id="ventana_tipo_accidente" class="modal fade app-modal-header">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
         <center><h4 class="modal-title">AGREGAR NUEVO TIPO ACCIDENTE</h4></center>
      </div>
      <div class="modal-body"> 
      	<div class="row">
	      	<div class="form-group col-xs-12 col-lg-12">
				<label >Escriba nuevo tipo de accidente</label>
				<input type="text" class="form-control" name="nueva_tipo_accidente" id="nueva_tipo_accidente" required="required">
			</div>
		
	      </div> 
      </div> 	 
      <div class="modal-footer">
		<button type="button" class="btn btn-info" onclick="confirma_nuevo_tipo_accidente()">CONFIRMAR AGREGAR</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Salir</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
...
<div id="ventana_partes_lesionadas" class="modal fade app-modal-header">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
         <center><h4 class="modal-title">AGREGAR NUEVA PARTE LESIONADA</h4></center>
      </div>
      <div class="modal-body"> 
      	<div class="row">
	      	<div class="form-group col-xs-12 col-lg-12">
				<label >Escriba nueva parte lesionada</label>
				<input type="text" class="form-control" name="nueva_parte_lesionada" id="nueva_parte_lesionada" required="required">
			</div>
		
	      </div> 
      </div> 	 
      <div class="modal-footer">
		<button type="button" class="btn btn-success" onclick="confirma_nueva_parte_lesionada()">CONFIRMAR AGREGAR</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Salir</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
